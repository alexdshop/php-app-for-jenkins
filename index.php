...
<head>
    ...
    <title>PHP Application - Jenkins-APP Deployment to AWS Elastic Beanstalk</title>
...
<body>
    <section class="congratulations">
        <h1>Congratulations! <br><font color=gold>DevOps Engineer</font></h1>
        ...
        <p>This environment is launched with Elastic Beanstalk PHP Platform and deployed by Jenkins from GitHub with webhooks</p>
    </section>
